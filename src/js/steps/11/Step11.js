...
export default class Step11 {
    ...
    constructor () {
        ...
        this.boid = new Boid( this.scene, 1.3 );
...
// this.maxDistance = Infinity;
    ...
    animate() {
        ...
        this.boid.mesh.position.x = Math.sin( this.clock.elapsedTime * 1.3 ) * 3;
        this.boid.mesh.position.y = Math.sin( this.clock.elapsedTime * 1.2 ) * 3;
        this.boid.mesh.position.z = Math.sin( this.clock.elapsedTime * 1.4 ) * 3;
        this.boid.update( this.clock.elapsedTime );
